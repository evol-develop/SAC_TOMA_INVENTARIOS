...
export const PurpleFlowTheme = createTheme({
  ...
  typography: {
    ...
    h1: {
      fontWeight: 700,
      fontSize: 35 -reductor
    },
    h2: {
      fontWeight: 700,
      fontSize: 30 -reductor
    },
    h3: {
      fontWeight: 700,
      fontSize: 25 -reductor,
      lineHeight: 1.4,
      color: colors.alpha.black[100]
    },
    h4: {
      fontWeight: 700,
      fontSize: 16 -reductor
    },
    h5: {
      fontWeight: 700,
      fontSize: 14 -reductor
